...
public class ImageAdapter extends BaseAdapter 
{
	...
	public ArrayList<sqlite.items> pictures;
...
//	public String[] titles = { "美图01", "美图02", "美图03", "美图04", "美图05", "美图06", "美图07"};
	...
	public ImageAdapter(Context c) 
	{
		...
		helper = new DatabaseHelper(mContext, null, 1);
		pictures = sqlite.QueryAll(helper);
...
//			list.add(map);
//		}
		mImages = new ImageView[pictures.size()];
	}
	...
	public boolean createReflectedImages() 
	{
		...
		for (int i=pictures.size()-1; i>=0; i--) {
			// 获取原始图片
			Bitmap originalImage = getBitmapFromByte(pictures.get(i).picture);
